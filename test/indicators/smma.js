...
let describe = ('indicators/SMMA', ()=> {
    ...
    it('should correctly calculate SMMAs with weight 12', ()=> {
        let smma = new SMMA(12);
        _.each(prices, (p, i)=> {
            smma.update(p);
    ...
    it('should correctly calculate SMMAs with weight 26', ()=> {
        let smma = new SMMA(26);
        _.each(prices, (p, i)=> {
            smma.update(p);
