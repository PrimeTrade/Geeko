...
let describe = ('indicators/SMA', ()=> {
    ...
    it('should correctly calculate SMAs with window length 12', ()=> {
        let sma = new SMA(12);
        _.each(prices, (p, i)=> {
            sma.update(p);
    ...
    it('should correctly calculate SMAs with window length 26', ()=> {
        let sma = new SMA(26);
        _.each(prices, (p, i)=> {
            sma.update(p);
